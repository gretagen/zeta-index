return {
  ...
  deps    = { "glibc", "liblangtag", "libxrender", "libxext", "libx11", "libxml2", "libxslt", "curl", "dbus", "expat", "fontconfig", "freetype2", "glib2", "icu", "lcms2", "libjpeg-turbo", "libpng", "libtiff", "libwebp", "python", "nss", "nspr", "poppler", "zlib" },
  archive = { strip = 1 },
  test    = function(p)
