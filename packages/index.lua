return {
  ...
  { name = "declaration", version = "1.0.0", summary = "Haliade OS declarative system configuration (haliade-synchronize)" },
  ...
  { name = "genzee", version = "1.0", summary = "btrfs generation manager for Haliade OS (Limine boot entries)" },
  ...
  { name = "spotify-client", version = "1.2.96", summary = "Spotify streaming music client" },
  ...
  { name = "zeta", version = "1.0.23", summary = "Zeta package manager for Haliade OS" },
