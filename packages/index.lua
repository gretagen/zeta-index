return {
  ...
  { name = "thesh", version = "0.2.0", summary = "Custom standalone POSIX shell for Haliade OS (default shell, replaces bash)" },
  ...
  { name = "zeta", version = "1.0.13", summary = "Zeta package manager for Haliade OS" },
