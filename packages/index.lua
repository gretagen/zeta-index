return {
  ...
  { name = "jemalloc", version = "5.4.0", summary = "General-purpose scalable concurrent malloc implementation (Arch binary)" },
  ...
  { name = "libical", version = "4.0.5", summary = "Reference implementation of the iCalendar data format (Arch binary)" },
  ...
  { name = "libqalculate", version = "5.12.0", summary = "Multi-purpose calculator library (Arch binary)" },
  ...
  { name = "libsodium", version = "1.0.22", summary = "Modern, portable, easy-to-use crypto library (Arch binary)" },
  ...
  { name = "libwireplumber", version = "0.5.17", summary = "PipeWire session manager client library (Arch binary)" },
  ...
  { name = "niri", version = "26.04", summary = "Scrollable-tiling Wayland compositor (Arch binary)" },
  ...
  { name = "noctalia", version = "5.1.0", summary = "Sleek, customizable desktop shell crafted for Wayland (Arch binary)" },
  ...
  { name = "wireplumber", version = "0.5.17", summary = "Session / policy manager for PipeWire (Arch binary)" },
