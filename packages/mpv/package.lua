return {
  ...
  deps    = { "glibc", "ffmpeg", "libass", "libbluray", "libpulse", "libva", "libx11", "libxext", "libxkbcommon", "libxv", "libegl", "libgl", "libplacebo", "mesa", "luajit", "libarchive", "libpipewire", "alsa-lib" },
  archive = { strip = 1 },
  test    = function(p)
